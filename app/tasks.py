...
from .logging_config import logger, setup_logging, get_correlation_id, set_correlation_id
...
@celery_app.task
def add_approved_reply_to_history(prospect_email: str, subject: str, body: str, correlation_id=None):
