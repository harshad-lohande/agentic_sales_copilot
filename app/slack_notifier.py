...
async def send_slack_notification(
    analysis_json: dict, original_sender: str, original_subject: str
):
    """
    ...
    try:
        ...
        logger.error({"message": "Error sending Slack notification", "error": str(e)})
