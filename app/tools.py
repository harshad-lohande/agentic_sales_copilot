...
def web_search(first_name: str, last_name: str, company: str):
    ...
    try:
        ...
        for query in queries:
            response = tavily.search(query=query, search_depth="basic", max_results=2, time_range="week")
        ...
        logger.error({"message": "Error during comprehensive web search", "error": str(e)})
